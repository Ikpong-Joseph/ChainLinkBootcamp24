...
contract CrossSourceMinter {
    ...
    function mintOnSepoliaFromfuji() external {
        // Mint from Fuji network = chain[1]
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            receiver: abi.encode(destinationMinter),
            data: abi.encodeWithSignature("mintFrom(address,uint256)", msg.sender, 1), // This is where the message.data in CrossDestinationMinter comes from
...
// CONTRACT ADDRESS
// 0x8d893291f51a102498A36Df8C7f4e890270F0038
