...
contract CrossChainPriceNFT is ERC721, ERC721URIStorage {
    ...
    mapping (uint256 => ChainStruct) chain; // Mapping for ChainStruct identifiers. i.e chain[0] = Sepolia. 0 is the uint256 sourceId in the mapping. Look @ constructor.

    //https://docs.chain.link/ccip/supported-networks/testnet
    constructor() ERC721("CrossChain Price", "CCPrice") {
        chain[0] = ChainStruct ({
            code: 16015286601757825753, // CHAIN SELECTOR
            name: "Sepolia",
            color: "#0000ff" //blue
        });
        chain[1] = ChainStruct ({
            code: 14767482510784806043, // CHAIN SELECTOR
            name: "Fuji",
            color: "#ff0000" //red
        });
        chain[2] = ChainStruct ({
            code: 12532609583862916517, // CHAIN SELECTOR
            name: "Mumbai",
            color: "#4b006e" //purple
        });
...
// CONTRACT ADDRESS
// 0xE27323AA6f5A44Eb557b3B976cEA761837De3639

// NFT COLLECTION ON TESTNET
// https://testnets.opensea.io/collection/crosschain-price-1046