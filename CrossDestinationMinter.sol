...
contract CrossDestinationMinter is CCIPReceiver {
    ...
    function testMessage() external {
        ...
        // Message in this case is to call "mintFrom(address,uint256)" from our nft contract.
        // The testMint() doirectly calls the function while
        // message converts the call to mintFrom to byte. Hence test that it works right.
    }
...
// CONTRACT ADDRESS
// 0x28f7468059F93BEE1D8fe10bC22EECc5191569B6
